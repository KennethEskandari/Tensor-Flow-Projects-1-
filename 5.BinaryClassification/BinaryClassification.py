...
x_test_vec = vectorizer.transform(x_test).toarray()        # Convert to dense array
...
history = model.fit(x_train_vec, y_train, epochs=5, batch_size=64, validation_data=(x_test_vec, y_test), verbose=1)
